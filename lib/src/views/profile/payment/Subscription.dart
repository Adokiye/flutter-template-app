...
class _SubscriptionState extends State<Subscription> {
  ...
  void initState() {
    ...
    StripePayment.setOptions(StripeOptions(
        ...
        //  merchantId: "Test",
        androidPayMode: 'test'));
    ApiAuth.getPlans().then((response) {
      print(response);
      dataJson = response;
    });
  }
  ...
  Future<dynamic> addCard(String subscribeId) async {
    ...
    ApiAuth.addCard(body).then((response) {
      ...
      ApiAuth.subscribe(subscribeBody).then((response) {
        print(response);
      });
    });
  }
                                    ...
                                    return Material(
                                        ...
                                        child: InkWell(
                                            onTap: () => addCard(
                                                dataJson['plans']['id']),
                                            child: card(
                                                dataJson['plans']['product'],
                                                "\$$dataJson['plans']['unit_amount']")));
                                  })
                              : Container()
                        ]),
                  )))),
